-- ============================================================================
-- RENAME NOTEBOOKS TO POLICY DOCUMENTS MIGRATION
...
-- Update source_type enum to remove audio support
-- Note: This requires recreating the enum and updating all references
-- We'll keep it for now to avoid breaking existing data, but audio type will not be used
