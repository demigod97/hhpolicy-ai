-- Fix RLS Policies for 5-Tier System
-- This migration fixes the existing functions and updates RLS policies

-- Drop and recreate the get_user_role function with correct parameter name
